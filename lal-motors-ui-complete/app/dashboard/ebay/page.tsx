...
export default function Page() {
  return (
    <>
      <PageHeader eyebrow="Sales Channel" title="eBay" description="Marketplace drafts, active listings, sold history and AI-generated listing content." primaryLabel="Create Draft"/>
